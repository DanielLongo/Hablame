      ...
      return (
        <div className="App">
            ...
            <MobileView>
                ...
                <p style={{marginTop: "0%", fontSize:17, marginLeft:"2%", marginRight:"2%"}}>Hablame.org is a free website dedicated to Spanish speaking practice. The site offers activities modeled after the AP Spanish exam including interpersonal and presentational speaking practice. <strong> The site also allows for c </strong></p>
                <CustomFooter/>
            </MobileView>
        </div>
  );
